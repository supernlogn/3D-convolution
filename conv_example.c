...
int main()
{
    int i;
    // create a 3D matrix
    double *mat1 = (double*) malloc(sizeof(double) * N0 * N1 * N2* N3); 
    int dim1[DIMS] = {N0, N1, N2, N3};
    ...
    double *mat2 = (double*) malloc(sizeof(double) * N0 * N1 * N2 * N3); 
    int dim2[DIMS] = {N0, N1, N2, N3};
    ...
    double *res_mat = (double*) malloc(sizeof(double) * ( 2 * (N0 + N0 - 1) * (N1 + N1 - 1) * (N2 + N2 - 1) ) * (N3 + N3 -1) ); 
    int res_dim[DIMS];
